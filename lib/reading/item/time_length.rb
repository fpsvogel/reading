module Reading
  class Item
    ...
    class Item::TimeLength
      ...
      #   2022/12/29.. x2/day -- not 3/3..6 -- 2023/8/1.. x4/day -- not 8/15..8/30 -- 11/3..4/29 x454 from ep. 747 -- not 2024/3/3..3/13
      #
      # example:
      #   4|🎤Hoy Hablamos||||spanish|0:14 each||2022/12/29..2023/7/31 x2/day -- not 3/3..6 -- ..11/2 x4/day -- not 8/15..8/30 -- ..2024/4/29 x454 from ep. 747 -- not 2024/3/3..3/13
      #
