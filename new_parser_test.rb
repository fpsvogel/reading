...
# require_relative "lib/reading/parsing/parse"
# require_relative "lib/reading/parsing/transform"
...
# parsed = Reading::Parsing::Parse.new(config).parse_row_to_intermediate_hash(str)
# items = parsed
# items = Reading::Parsing::Transform.new(config).transform_intermediate_hash_to_item_hashes(parsed)
